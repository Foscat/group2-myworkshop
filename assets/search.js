...
///////////// Tag select funtion **Needs more work**--make objects to hold tags and then allow user to make thier own
  ...
  // subject select function **Needs subject selector and values to take in**..
  // --use a hard coded check box because inputs here need to be case and spelling sepcific 
  $(document).on("click", "#subject-select", function(){
    console.log(this);
    $("#searched").empty();
    $("#search-content").empty();

    queryUrl = "https://www.googleapis.com/books/v1/volumes?q=non-fiction+subject:history" +
    "&filter=ebooks&orderBy=relevance&maxResults=30&key=AIzaSyCMiu9BKRYCqsMEi73bivxlnUF7Ow-oQO4";
